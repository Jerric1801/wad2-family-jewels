<template>
  <DefaultLayout>
    <div
      ref="homeContainer"
      class="bg-white h-[400vh] w-[100vw] flex flex-col justify-center relative"
    >
      <!-- Intro -->
      <div
      ...
      >
        <div
          ...
          :key="index"
          class="flex justify-center items-center h-[95vh] sticky top-0 shadow-[0_-1px_3px_rgba(0,0,0,0.1),_0_-1px_2px_rgba(0,0,0,0.25)] text-[10rem] bg-cover bg-center"
    ...
    >
      <div class="w-[80vw] text-center md:w-[50vw]">
        ...
        <p class="mt-3">
          Fine-tune images with easy-to-use editing tools. Adjust lighting,
          remove backgrounds, and even select the perfect model skin tone to
          match your brand's style.
        </p>
      </div>
      <div
        class="h-[45vh] w-[80vw] md:h-[60vh] md:w-[60vw] relative overflow-hidden rounded-md"
      ...
      >
        <div
          ...
          :style="{
            'background-image': `url(${productImages[1]})`,
        ...
        ></div>
        <div
          class="absolute top-0 h-full w-2 bg-gray-300 cursor-ew-resize"
    ...
    >
      <div
        class="w-[80vw] md:h-[80vh] md:w-[60%] flex flex-col justify-center items-center gap-10 text-center"
      >
...
export default {
  ...
  data() {
    return {
      ...
      ring: null,
      rotation: 0,
      productImages: [product1, product2],
      backgroundImages: [background3, background2, background1],
      currentImageIndex: 0,
    };
  },
  mounted() {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      const scrollDirection =
        currentScrollTop > this.previousScrollTop ? "down" : "up";
    ...
    updateSliderPosition(clientX) {
      ...
      const maxWidth =
        containerRect.width - this.$refs.sliderHandle.offsetWidth; // Adjust for handle width
