<template>
  <DefaultLayout>
    <div class="container mx-auto px-4 pt-[150px]">
      <h1 class="text-3xl font-bold mb-8 animate-fade-in">Your Dashboard</h1>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="p-4 bg-white rounded-lg shadow-md">
          <h2 class="text-sm font-semibold text-gray-500 mb-1">Total Revenue</h2>
          <p class="text-2xl font-bold text-gray-900">$120,000</p>
        </div>
        <!-- KPI Card: Profit Margin -->
        <div class="p-4 bg-white rounded-lg shadow-md">
          <h2 class="text-sm font-semibold text-gray-500 mb-1">Profit Margin</h2>
...
<script>
import { Chart, LineController, LineElement, PointElement, LinearScale, Title, CategoryScale, PieController, ArcElement, BarController, BarElement, Filler, Tooltip, Legend } from 'chart.js';
...
export default {
  ...
  mounted() {
    ...
    Chart.register(LineController, LineElement, PointElement, LinearScale, CategoryScale, Title, PieController, ArcElement, BarController, BarElement, ChartDataLabels, Filler, Tooltip, Legend);
      ...
      new Chart(ctx, {
        ...
        options: {
          ...
          plugins: {
            ...
            datalabels: {
              display: true,
              formatter: (value, context) => `${((value / context.chart.data.datasets[0].data.reduce((a, b) => a + b)) * 100).toFixed(2)}%`
            }
          }
        }
      });
      ...
      new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            ...
            backgroundColor: ['rgba(255, 159, 64, 0.7)', 'rgba(153, 102, 255, 0.7)', 'rgba(255, 205, 86, 0.7)', 'rgba(75, 192, 192, 0.7)'],
            borderColor: ['rgba(255, 159, 64, 1)', 'rgba(153, 102, 255, 1)', 'rgba(255, 205, 86, 1)', 'rgba(75, 192, 192, 1)'],
            borderWidth: 1,
          }]
        },
        options: {
