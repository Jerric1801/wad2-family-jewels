<template>
  <DefaultLayout>
    <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 pt-[20vh]">
      <div class="max-w-md w-full space-y-8">
        <div>
          <img class="mx-auto h-40 w-auto" src="@/assets/images/logo/logo.png" alt="Family Jewels Logo" />
          ...
          <p class="mt-2 text-center text-base text-gray-600">
            Or
            <router-link to="/login" class="font-medium text-blue hover:text-indigo-500">
        ...
        <form class="mt-8 space-y-6" @submit.prevent="handleSignUp">
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input id="full-name" v-model="name" name="name" type="text" required
            ...
            <div>
              ...
              <input id="confirm-password" name="confirm-password" v-model="confirmPassword" type="password"
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              ...
              <label for="terms-and-privacy" class="ml-2 block text-sm text-gray-900">
                I agree to the
                <router-link to="/terms" class="font-medium text-blue hover:text-indigo-500">Terms of
                  Service</router-link>
                and
                <router-link to="/privacy" class="font-medium text-blue hover:text-indigo-500">Privacy
                  Policy</router-link>
              </label>
            </div>
          </div>
          ...
          <div>
            <button type="submit"
              ...
              <span class="absolute left-0 inset-y-0 flex items-center pl-3">
                ...
                <svg class="h-6 w-6 text-purple group-hover:text-blue" xmlns="http://www.w3.org/2000/svg"
    ...
    <!-- Success Popup -->
    <div v-if="showSuccessPopup" class="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
